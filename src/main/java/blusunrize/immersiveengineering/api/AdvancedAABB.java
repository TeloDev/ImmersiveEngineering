...
public class AdvancedAABB extends AxisAlignedBB {
    ...
    public AdvancedAABB(
            double xMin, double yMin, double zMin, double xMax, double yMax, double zMax, ForgeDirection fd) {
        this(xMin, yMin, zMin, xMax, yMax, zMax, fd, new Vec3[0][]);
    }

    public AdvancedAABB(
            double xMin, double yMin, double zMin, double xMax, double yMax, double zMax, Vec3[]... drawOverride) {
