...
public class ShaderCaseChemthrower extends ShaderCase {
    ...
    public int getPasses(ItemStack shader, ItemStack item, String modelPart) {
        ...
        if (modelPart.equals("cage")) return (renderCageOnBase ? 2 : 1) + i;
        if (modelPart.equals("base")) return 3 + i;
        if (modelPart.equals("tanks")) return (tanksUncoloured ? 1 : 2) + i;
        return 2 + i;
    }
    ...
    public IIcon getReplacementIcon(ItemStack shader, ItemStack item, String modelPart, int pass) {
        ...
        if (modelPart.equals("cage")) return pass == 0 && renderCageOnBase ? i_chemthrowerBase : i_chemthrowerOverlay;
    ...
    public int getTextureType(String modelPart, int pass) {
        ...
        if (modelPart.equals("grip")) return pass == 0 ? 0 : pass + 1;
        return pass + 1;
    }
