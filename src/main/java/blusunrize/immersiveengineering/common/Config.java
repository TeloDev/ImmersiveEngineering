...
public class Config {
    ...
    public static void init(FMLPreInitializationEvent event) {
        ...
        Property propLastVersion = config.get(
                "general",
                "LastVersion",
                .54,
        ...
        Property connectionValidation = config.get(
                "general",
        ...
        Property cableProperty = config.get(
                "general",
                "Cable transfer rates",
                new int[] {2048, 8192, 32768, 0, 0},
                "The transfer rates in RF/t for the cable tiers (copper, electrum, HV, Structural Rope & Cable(no transfer) )");
        if (cableProperty.getIntList().length < 5) cableProperty.set(new int[] {2048, 8192, 32768, 0, 0});
        setIntArray("cableTransferRate", cableProperty.getIntList());

        cableProperty = config.get(
                "general",
                "Cable loss",
                new double[] {.05, .025, .025, 1, 1},
        ...
        if (cableProperty.getDoubleList().length < 5) cableProperty.set(new double[] {.05, .025, .025, 1, 1});
        setDoubleArray("cableLossRatio", cableProperty.getDoubleList());

        cableProperty = config.get(
                "general", "Cable colouration", new int[] {0xd4804a, 0xedad62, 0x6f6f6f, 0x967e6d, 0x6f6f6f}, "");
        ...
        if (cableProperty.getIntList().length < 5) cableProperty.set(new int[] {16, 16, 32, 32, 32});
        ...
        setBoolean(
                ...
                config.get(
                        ...
                        .getBoolean());
        setDouble(
                "increasedTileRenderdistance",
                config.get(
                                "general",
                                "Increased Tile Renderdistance",
                                1.5,
                        ...
                        .getDouble());
        setBoolean(
                "disableHammerCrushing",
                config.get(
                                "general",
                                "Disable Hammer Crushing",
                                false,
        ...
        setStringArray(
                ...
                config.get(
                                "general",
                                "Preferred Ores",
                                new String[] {"ImmersiveEngineering", "ThermalFoundation"},
        ...
        setInt(
                ...
                config.get("machines", "Excavator: Consumed", 4096, "The RF per tick the Excavator will consume to dig")
                        .getInt());
        setDouble(
                "excavator_speed",
                config.get(
        ...
        setInt(
                ...
                config.get(
                        ...
                        .getInt());
        setBoolean(
                "arcfurnace_electrodeCrafting",
                config.get(
                                "machines",
                                "Arc Furnace: Craftable Blueprint",
                                false,
        ...
        setBoolean(
                "lantern_spawnPrevent",
                config.get(
                                "machines",
                                "Powered Lantern: Spawn Prevention",
                                true,
                                "Set this to false to disable the mob-spawn prevention of the Powered Lantern")
                        .getBoolean());
        setBoolean(
                "floodlight_spawnPrevent",
                config.get(
                                "machines",
                                "Floodlight: Spawn Prevention",
                                true,
        ...
        setInt(
                ...
                config.get(
                        ...
                        .getInt());
        setInt(
                "pump_consumption_accelerate",
                config.get(
                                "machines",
                                "Fluid Pump: Acceleration",
                                5,
        ...
        setInt(
                ...
                config.get(
                        ...
                        .getInt());
        setInt(
                "preheater_consumption",
                config.get(
                                "machines",
                                "BlastFurnacePreheater: Charge",
                                32,
        ...
        setBoolean(
                "hardmodeBulletRecipes",
                config.get(
                                "tools",
                                "Bullets: Hardmode Recipes",
                                false,
                                "Enable this to use the old, harder bullet recipes(require one ingot per bullet)")
                        .getBoolean());
        setDouble(
                "BulletDamage-Casull",
                config.get("tools", "BulletDamage-Casull", 10d, "The amount of base damage a Casull Cartridge inflicts")
                        .getDouble());
        setDouble(
                "BulletDamage-AP",
                config.get(
        ...
        setDouble(
                "BulletDamage-Homing",
                config.get("tools", "BulletDamage-Homing", 10d, "The amount of base damage a Homing Cartridge inflicts")
                        .getDouble());
        setDouble(
                "BulletDamage-Wolfpack",
                config.get(
                                "tools",
                                "BulletDamage-Wolfpack",
                                6d,
        ...
        setDouble(
                "BulletDamage-Silver",
                config.get("tools", "BulletDamage-Silver", 10d, "The amount of damage a silver bullet inflicts")
                        .getDouble());
        setDouble(
                "BulletDamage-Potion",
                config.get("tools", "BulletDamage-Potion", 1d, "The amount of base damage a Phial Cartridge inflicts")
                        .getDouble());

        setInt(
                "chemthrower_consumption",
                config.get(
                                "tools",
                                "ChemThrower: Consumed",
                                10,
        ...
        setInt(
                "railgun_consumption",
                config.get("tools", "Railgun: Consumed", 800, "The base amount of RF consumed per shot by the Railgun")
                        .getInt());
        setDouble(
                "railgun_damage_multiplier",
                config.get(
                                "tools",
        ...
        ItemJerrycan.blacklist = Sets.newHashSet(config.get(
                        "tools",
                        "Jerrycan Blacklist",
                        new String[] {},
        ...
        for (String key : IECompatModule.moduleClasses.keySet())
            setBoolean(
                    ...
                    config.get(
                                    "compatability",
                                    "Enable Compatmodule: " + key,
                                    true,
                                    "Set this to false to disable IE's built in compatability with " + key)
                            .getBoolean());
    ...
    public static int getPotionID(int base, String key) {
        ...
        int i = config.get(
                        "potions",
                        key,
                        IEPotions.getNextPotionId(base),
                        "The potion ID for the " + key + " potion effect")
                .getInt();
        config.save();
        return i;
    }
