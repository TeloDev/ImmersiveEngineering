...
public class ItemBlockIESlabs extends ItemBlockIEBase {
    ...
    public boolean onItemUse(
        ...
        if ((side == 0 || side == 1)
                && field_150939_a.equals(world.getBlock(x0, y0, z0))
                && world.getBlockMetadata(x0, y0, z0) == stack.getItemDamage()) {
        ...
        } else if (field_150939_a.equals(world.getBlock(x1, y1, z1))
                && world.getBlockMetadata(x1, y1, z1) == stack.getItemDamage()) {
        ...
        } else return super.onItemUse(stack, player, world, x, y, z, side, hitX, hitY, hitZ);
        if (stackSlab != null) {
