            ...
            for (int w = 0; w < 3; w++)
                for (int h = 0; h < 3; h++) {
                    ...
                    if (l == 5) {
                        ...
                        if (w == 0 && h == 1) structure[h + 2][l + 2][w] = new ItemStack(IEContent.blockStorage, 1, 7);
                        else
                            m = w == 2
                                    ? BlockMetalDecoration.META_lightEngineering
                                    : BlockMetalDecoration.META_heavyEngineering;
                    } else if (l == 3) structure[h + 2][l + 2][w] = new ItemStack(IEContent.blockStorage, 1, 7);
                    else if (w == 2)
                    ...
                    if (m >= 0) structure[h + 2][l + 2][w] = new ItemStack(IEContent.blockMetalDecoration, 1, m);
                }
        ...
        for (int h = 0; h < 7; h++)
            for (int l = 0; l < 7; l++) {
                ...
                if (l == 0
                        ...
                        || h == 6
                        || ((l == 1 || l == 5) && (h == 1 || h == 5))
                        || (h == 3 && l == 3)) structure[h][l][1] = new ItemStack(IEContent.blockStorage, 1, 7);
                else
                    structure[h][l][1] =
