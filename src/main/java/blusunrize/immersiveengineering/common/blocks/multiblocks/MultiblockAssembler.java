...
public class MultiblockAssembler implements IMultiblock {
    ...
    public boolean overwriteBlockRender(ItemStack stack, int iterator) {
        if (iterator == 10 || iterator == 16) GL11.glRotatef(-90, 0, 1, 0);
        if (iterator == 20 || iterator == 23 || iterator == 26) GL11.glRotatef(-90, 0, 1, 0);
        if (iterator == 18 || iterator == 21 || iterator == 24) GL11.glRotatef(90, 0, 1, 0);
