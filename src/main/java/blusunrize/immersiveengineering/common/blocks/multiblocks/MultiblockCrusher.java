...
public class MultiblockCrusher implements IMultiblock {
    ...
    static {
        ...
        for (int h = 0; h < 3; h++)
            for (int l = 0; l < 5; l++)
                for (int w = 0; w < 3; w++) {
                    if ((l == 0 && h == 2) || (l == 4 && h == 2) || (l == 4 && w == 2 && h > 0)) continue;
                    if (l == 0)
                        ...
                        if (h < 1)
                            structure[h][l][w] = new ItemStack(
                                    IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_scaffolding);
                        else if (h < 2 && w < 2)
                            structure[h][l][w] = new ItemStack(
                                    IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_lightEngineering);
                    } else if (h == 0)
                        ...
                        structure[h][l][w] = new ItemStack(
                                ...
                                (w == 1 && l == 2)
                                        ? BlockMetalDecoration.META_lightEngineering
                                        : BlockMetalDecoration.META_fence);
                    else if (h == 2) structure[h][l][w] = new ItemStack(Blocks.hopper);
                }
    }
    ...
    public boolean createStructure(World world, int x, int y, int z, int side, EntityPlayer player) {
        ...
        if (world.getBlock(x, y - 1, z).equals(IEContent.blockMetalDecoration)
                ...
                && world.getBlock(
                                x + (side == 4 ? 2 : side == 5 ? -2 : 0),
                                y - 1,
                                z + (side == 2 ? 2 : side == 3 ? -2 : 0))
        ...
        if (b) {
            for (int l = 0; l < 3; l++)
                for (int w = -2; w <= 2; w++)
                    for (int h = -1; h <= 1; h++) {
                        if ((w == -2 && h == 1) || (w == 2 && h == 1) || (w == 2 && l == 2 && h > -1)) continue;
                        int ww = mirrored ? -w : w;
                        ...
                        world.setBlock(
                                xx, yy, zz, IEContent.blockMetalMultiblocks, BlockMetalMultiblocks.META_crusher, 0x3);
                        ...
                        if (curr instanceof TileEntityCrusher) {
                            ...
                            tile.offset = new int[] {
                                (side == 4 ? l - 1 : side == 5 ? 1 - l : side == 2 ? -ww : ww),
                                h + 1,
                                (side == 2 ? l - 1 : side == 3 ? 1 - l : side == 5 ? -ww : ww)
                            };
            ...
            for (int w = -2; w <= 2; w++)
                for (int h = -1; h <= 1; h++) {
                    ...
                    if (w == -2) {
                        ...
                        if (l < 2
                                && !(world.getBlock(xx, yy, zz).equals(IEContent.blockMetalDecoration)
