...
public class MultiblockSqueezer implements IMultiblock {
                ...
                for (int h = -1; h <= 1; h++) {
                    ...
                    if (h == 0 && (w != 0 || l != 1)) {
                        if (!(world.getBlock(xx, yy, zz).equals(IEContent.blockMetalMultiblocks)
                                && world.getBlockMetadata(xx, yy, zz) == BlockMetalMultiblocks.META_squeezer))
                            return false;
                    } else {
                ...
                for (int h = -1; h <= 1; h++) {
                    ...
                    if (h == 0 && (w != 0 || l != 1)) world.markBlockForUpdate(startX + xx, startY + yy, startZ + zz);
                        ...
                        world.setBlock(
                                ...
                                BlockMetalMultiblocks.META_squeezer,
                                0x3);
    ...
    public ItemStack[] getTotalMaterials() {
        return new ItemStack[] {
            ...
            new ItemStack(IEContent.blockMetalMultiblocks, 8, BlockMetalMultiblocks.META_squeezer)
        };
    }
}
