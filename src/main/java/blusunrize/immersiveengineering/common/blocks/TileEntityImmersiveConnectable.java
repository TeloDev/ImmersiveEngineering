...
public abstract class TileEntityImmersiveConnectable extends TileEntityIEBase
    ...
    public void onChunkUnload() {
        super.onChunkUnload();
        if (!worldObj.isRemote) ImmersiveNetHandler.INSTANCE.setProxy(new DimensionBlockPos(this), new IICProxy(this));
    }
    ...
    public void onDataPacket(NetworkManager net, S35PacketUpdateTileEntity pkt) {
        ...
        if (worldObj != null && worldObj.isRemote && !Minecraft.getMinecraft().isSingleplayer()) {
            ...
            for (int i = 0; i < connectionList.tagCount(); i++) {
                ...
                } else IELogger.error("CLIENT read connection as null");
            }
        }
    }
