...
public class TileEntityLightningRod extends TileEntityMultiblockPart implements IEnergyProvider {
    ...
    public int extractEnergy(ForgeDirection from, int maxExtract, boolean simulate) {
        ...
        if (master != null) return master.energyStorage.extractEnergy(maxExtract, simulate);
    ...
    public int getEnergyStored(ForgeDirection from) {
        TileEntityLightningRod master = master();
        if (master != null) return master.getEnergyStored(from);
    ...
    public int getMaxEnergyStored(ForgeDirection from) {
        TileEntityLightningRod master = master();
        if (master != null) return master.getMaxEnergyStored(from);
