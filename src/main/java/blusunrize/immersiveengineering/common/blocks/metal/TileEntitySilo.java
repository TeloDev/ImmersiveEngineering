...
public class TileEntitySilo extends TileEntityMultiblockPart implements ISidedInventory, IDeepStorageUnit {
    ...
    public int getSizeInventory() {
        if (!formed || !(pos == 4 || pos == 58)) return 0;
        return 2;
    }
    ...
    public void setInventorySlotContents(int slot, ItemStack stack) {
        ...
        if (slot == 0) this.inputStack = stack;
        else this.outputStack = stack;
        this.markDirty();
        updateComparatorValuesPart2();
    }
    ...
    public void markDirty() {
        ...
        if (storageAmount != oldStorage || forceUpdate) worldObj.markBlockForUpdate(xCoord, yCoord, zCoord);
        forceUpdate = false;
    }
