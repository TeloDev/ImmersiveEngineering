...
public class TileEntityBalloon extends TileEntityConnectorStructural {
    ...
    public Vec3 getRaytraceOffset(IImmersiveConnectable link) {
        ...
        if (Math.abs(zDif) > Math.abs(xDif)) return Vec3.createVectorHelper(.5, .09375, zDif > 0 ? .8125 : .1875);
        else return Vec3.createVectorHelper(xDif > 0 ? .8125 : .1875, .09375, .5);
    }
    ...
    public Vec3 getConnectionOffset(Connection con) {
        ...
        if (Math.abs(zDif) > Math.abs(xDif)) return Vec3.createVectorHelper(.5, .09375, zDif > 0 ? .78125 : .21875);
        else return Vec3.createVectorHelper(xDif > 0 ? .78125 : .21875, .09375, .5);
    }
}
