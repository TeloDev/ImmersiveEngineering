        ...
        if (tile instanceof TileEntityBalloon) {
            ...
            if (Utils.isHammer(equipped)) {
                ...
                if (side < 2 && style == 0)
                    ...
                    if (style == 0) target = (hitX < .375 || hitX > .625) ? 1 : 0;
                    else target = (hitY > .5625 && hitY < .75) ? 1 : 0;
                } else if (side >= 4) {
                    if (style == 0) target = (hitZ < .375 || hitZ > .625) ? 1 : 0;
                    else target = (hitY > .5625 && hitY < .75) ? 1 : 0;
                }
                int heldDye = Utils.getDye(equipped);
                if (heldDye == -1) return false;
                if (target == 0) {
                    if (((TileEntityBalloon) tile).colour0 == heldDye) return false;
                    ((TileEntityBalloon) tile).colour0 = (byte) heldDye;
                } else {
                    if (((TileEntityBalloon) tile).colour1 == heldDye) return false;
