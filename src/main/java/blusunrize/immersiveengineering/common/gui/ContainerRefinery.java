...
public class ContainerRefinery extends Container {
    ...
    public ContainerRefinery(InventoryPlayer inventoryPlayer, TileEntityRefinery tile) {
        ...
        //		if(slot==4)
        //			return (tank2.getFluidAmount()<=0?FluidContainerRegistry.isEmptyContainer(stack):
        ...
        // (tank1.getFluidAmount()<=0||DieselHandler.findIncompleteRefineryRecipe(fs, tank1.getFluid())!=null);
        //		if(slot==2)
        //			return (tank1.getFluidAmount()<=0||fs.isFluidEqual(tank1.getFluid())) &&
        // (tank0.getFluidAmount()<=0||DieselHandler.findIncompleteRefineryRecipe(fs, tank0.getFluid())!=null);
        ...
        this.addSlotToContainer(new IESlot.FluidContainer(this, tile, 0, 37, 15, false) {
            ...
            public boolean isItemValid(ItemStack itemStack) {
                ...
                if (DieselHandler.findIncompleteRefineryRecipe(fs, null) == null) return false;
                return (tileF.tank0.getFluidAmount() <= 0 || fs.isFluidEqual(tileF.tank0.getFluid()))
                        && (tileF.tank1.getFluidAmount() <= 0
                                || DieselHandler.findIncompleteRefineryRecipe(fs, tileF.tank1.getFluid()) != null);
            }
        });
        ...
        this.addSlotToContainer(new IESlot.FluidContainer(this, tile, 2, 85, 15, false) {
            ...
            public boolean isItemValid(ItemStack itemStack) {
                ...
                if (fs == null) return false;
                if (DieselHandler.findIncompleteRefineryRecipe(fs, null) == null) return false;
                return (tileF.tank1.getFluidAmount() <= 0 || fs.isFluidEqual(tileF.tank1.getFluid()))
                        && (tileF.tank0.getFluidAmount() <= 0
                                || DieselHandler.findIncompleteRefineryRecipe(fs, tileF.tank0.getFluid()) != null);
            }
        });
        ...
        this.addSlotToContainer(new IESlot.FluidContainer(this, tile, 4, 133, 15, true) {
            ...
            public boolean isItemValid(ItemStack itemStack) {
                return super.isItemValid(itemStack)
                        || (itemStack != null && itemStack.getItem() instanceof IFluidContainerItem);
            }
        });
