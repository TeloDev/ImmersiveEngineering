                    ...
                    if (pos[0] != world.provider.dimensionId)
                        ...
                        player.addChatMessage(new ChatComponentTranslation(Lib.CHAT_WARN + "tooFar"));
                            ...
                            || !((IImmersiveConnectable) tileEntityLinkingPos)
                                    .canConnectCable(getWireType(stack), target))
                        ...
                        Set<Connection> outputs =
                                ImmersiveNetHandler.INSTANCE.getConnections(world, Utils.toCC(nodeHere));
                        if (outputs != null)
                        ...
                        if (connectionExists)
                            ...
                            if (canSee) {
                                ...
                                ImmersiveNetHandler.INSTANCE.addConnection(
                                        world, Utils.toCC(nodeHere), Utils.toCC(nodeLink), distance, type);
                                ...
                                world.addBlockEvent(
                                        pos[1], pos[2], pos[3], ((TileEntity) nodeLink).getBlockType(), -1, 0);
