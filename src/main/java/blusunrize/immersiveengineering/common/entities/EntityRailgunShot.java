...
public class EntityRailgunShot extends EntityIEProjectile {
    ...
    public void setAmmoSynced() {
        if (this.getAmmo() != null) this.dataWatcher.updateObject(dataMarker_ammo, getAmmo());
    }
    ...
    public RailgunProjectileProperties getAmmoProperties() {
        if (ammoProperties == null && ammo != null) ammoProperties = RailgunHandler.getProjectileProperties(ammo);
    ...
    public void writeEntityToNBT(NBTTagCompound nbt) {
        ...
        if (this.ammo != null) nbt.setTag("ammo", this.ammo.writeToNBT(new NBTTagCompound()));
    }
