        ...
        extends EntityArrow // Yes I have to extend arrow or else it's all weird and broken >_>
{
    ...
    public void onUpdate() {
        if (this.getShooter() == null && this.worldObj.isRemote) this.shootingEntity = getShooterSynced();
    ...
    public void writeEntityToNBT(NBTTagCompound nbt) {
        ...
        if (this.shootingEntity != null) nbt.setString("shootingEntity", this.shootingEntity.getCommandSenderName());
    }
