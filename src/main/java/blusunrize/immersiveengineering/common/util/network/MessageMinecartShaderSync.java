...
public class MessageMinecartShaderSync implements IMessage {
    ...
    public MessageMinecartShaderSync(Entity entity, Object o) {
        ...
        if (o instanceof EntityPropertiesShaderCart) shader = ((EntityPropertiesShaderCart) o).getShader();
        else request = true;
    }
    ...
    public void fromBytes(ByteBuf buf) {
        ...
        if (!request) this.shader = ByteBufUtils.readItemStack(buf);
    }
    ...
    public void toBytes(ByteBuf buf) {
        ...
        if (!request) ByteBufUtils.writeItemStack(buf, this.shader);
    }
