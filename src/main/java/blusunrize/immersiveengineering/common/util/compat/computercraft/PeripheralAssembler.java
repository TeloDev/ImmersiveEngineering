...
public class PeripheralAssembler extends IEPeripheral {
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
        ...
        if (te == null) throw new LuaException("The assembler was removed");
        switch (method) {
            case 0: // has ingredients
                ...
                if (recipe > 3 || recipe < 1) throw new LuaException("Only recipes 1-3 are available");
                if (te.patterns[recipe - 1].inv[9] == null) throw new LuaException("The requested recipe is invalid");
                ArrayList<ItemStack> queryList = new ArrayList<>();
                for (ItemStack stack : te.inventory) if (stack != null) queryList.add(stack.copy());
            ...
            case 2: // getRecipe
                ...
                for (int i = 0; i < 9; i++) ret.put("in" + (i + 1), saveStack(te.patterns[recipe - 1].inv[i]));
            ...
            case 4: // get tank
                ...
                if (tank > 3 || tank < 1) throw new LuaException("Only tanks 1-3 are available");
            ...
            case 7: // get stack
                ...
                if (slot > 18 || slot < 1) throw new LuaException("Only slots 1-18 are available");
