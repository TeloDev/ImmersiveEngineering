...
public class PeripheralCrusher extends IEPeripheral {
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
        ...
        if (te == null) throw new LuaException("The crusher was removed");
        switch (method) {
            case 0: // queue length
            ...
            case 4: // max progress
                if (te.inputs.isEmpty()) throw new LuaException("The crusher doesn't have any inputs");
                int time = te.getRecipeTime(te.inputs.get(0));
                if (time <= 0) throw new LuaException("The current crusher recipe is invalid");
