...
public class NetherOresHelper {
    ...
    public static int getCrushingResult(String ore) {
        if (!Loader.isModLoaded("NetherOres")) return 4;
        try {
            if (c_Ores == null) c_Ores = Class.forName("powercrystals.netherores.ores.Ores");
            if (c_Ores != null && m_getMaceCount == null) m_getMaceCount = c_Ores.getDeclaredMethod("getMaceCount");
