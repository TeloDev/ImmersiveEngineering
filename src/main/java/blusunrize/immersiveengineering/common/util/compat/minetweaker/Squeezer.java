...
public class Squeezer {
    ...
    public static void addRecipe(IItemStack output, ILiquidStack fluid, IIngredient input, int time) {
        ...
        SqueezerRecipe r = new SqueezerRecipe(
    ...
    public static void removeFluidRecipe(ILiquidStack fluid) {
        if (MTHelper.toFluidStack(fluid) != null) MineTweakerAPI.apply(new RemoveFluid(MTHelper.toFluidStack(fluid)));
    }
    ...
    private static class RemoveFluid implements IUndoableAction {
        ...
        public void undo() {
            if (removedRecipes != null)
                for (SqueezerRecipe recipe : removedRecipes) if (recipe != null) DieselHandler.squeezerList.add(recipe);
        }
    ...
    public static void removeItemStack(IItemStack stack) {
        if (MTHelper.toStack(stack) != null) MineTweakerAPI.apply(new RemoveStack(MTHelper.toStack(stack)));
    }
