...
public class ChiselHelper extends IECompatModule {
    ...
    public void init() {
        ...
        FMLInterModComms.sendMessage(
                "chisel", "variation:add", "steel_scaffold|ImmersiveEngineering:metalDecoration|1");
        FMLInterModComms.sendMessage(
                "chisel", "variation:add", "steel_scaffold|ImmersiveEngineering:metalDecoration|11");
        FMLInterModComms.sendMessage(
                "chisel", "variation:add", "aluminum_scaffold|ImmersiveEngineering:metalDecoration|13");
        FMLInterModComms.sendMessage(
                "chisel", "variation:add", "aluminum_scaffold|ImmersiveEngineering:metalDecoration|14");
    }
