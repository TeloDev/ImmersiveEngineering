...
public class GregTechHelper extends IECompatModule {
    ...
    public void init() {
        ...
        IERecipes.addOreDictAlloyingRecipe(
                "ingotHotNichrome", 5, "Chrome", 400, 4096, "dustNickel", "dustNickel", "dustNickel", "dustNickel");
        ...
        IERecipes.addOreDictAlloyingRecipe(
                "ingotMagnalium", 3, "Magnesium", 200, 512, "dustAluminium", "dustAluminium");
        IERecipes.addOreDictAlloyingRecipe(
                "ingotBatteryAlloy", 5, "Antimony", 200, 512, "dustLead", "dustLead", "dustLead", "dustLead");
        ...
        ExcavatorHandler.addMineral(
                "Wolframite", 15, .2f, new String[] {"oreTungsten", "oreIron", "oreManganese"}, new float[] {
                    .55f, .3f, .15f
                });
        ...
        for (GregsTerribleFluidPotions fluidPotion : GregsTerribleFluidPotions.values()) {
            ...
            ChemthrowerHandler.registerEffect(
                    ...
                    new ChemthrowerEffect_Potion(
                            null, 0, fluidPotion.potion, fluidPotion.baseDuration, fluidPotion.baseAmplifier));
            if (fluidPotion.strong)
                ChemthrowerHandler.registerEffect(
                        ...
                        new ChemthrowerEffect_Potion(
                                ...
                                0,
                                fluidPotion.potion,
                                (int) (fluidPotion.baseDuration * .5f),
                                fluidPotion.baseAmplifier + 1));
            if (fluidPotion.extended)
                ChemthrowerHandler.registerEffect(
                        potionName + ".long",
                        new ChemthrowerEffect_Potion(
                                null, 0, fluidPotion.potion, fluidPotion.baseDuration * 2, fluidPotion.baseAmplifier));
            ...
            if (fluidPotion.splash)
                ChemthrowerHandler.registerEffect(
                        ...
                        new ChemthrowerEffect_Potion(
                                ...
                                0,
                                fluidPotion.potion,
                                (int) (fluidPotion.baseDuration * .75f),
                                fluidPotion.baseAmplifier));
            if (fluidPotion.strong && fluidPotion.splash)
                ChemthrowerHandler.registerEffect(
                        potionName + ".strong.splash",
                        new ChemthrowerEffect_Potion(
                                null,
                                0,
                                fluidPotion.potion,
                                (int) (fluidPotion.baseDuration * .375f),
                                fluidPotion.baseAmplifier + 1));
            if (fluidPotion.extended && fluidPotion.splash)
                ChemthrowerHandler.registerEffect(
                        potionName + ".long.splash",
                        new ChemthrowerEffect_Potion(
                                null,
                                0,
                                fluidPotion.potion,
                                (int) (fluidPotion.baseDuration * 1.5f),
                                fluidPotion.baseAmplifier));
        }
        ChemthrowerHandler.registerEffect(
                "liquid_light_oil",
                new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.flammable.id, 100, 0)));
        ...
        ChemthrowerHandler.registerEffect(
                "liquid_heavy_oil",
                new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.flammable.id, 120, 0)));
        ...
        ChemthrowerHandler.registerEffect(
                "liquid_heavy_fuel",
                new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.flammable.id, 100, 1)));
        ...
        ChemthrowerHandler.registerEffect(
                ...
                new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.flammable.id, 60, 1)));
        ChemthrowerHandler.registerFlammable("liquid_cracked_light_fuel");
        ChemthrowerHandler.registerEffect(
                "liquid_cracked_heavy_fuel",
                new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.flammable.id, 80, 1)));
        ...
        ChemthrowerHandler.registerEffect(
                "nitrofuel", new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.flammable.id, 100, 1)));
        ChemthrowerHandler.registerFlammable("nitrofuel");
        ChemthrowerHandler.registerEffect(
                "lubricant", new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.slippery.id, 80, 0)));
        ChemthrowerHandler.registerEffect(
                "sulfuricacid", new ChemthrowerEffect_Damage(IEDamageSources.causeAcidDamage(), 2));
    ...
    public static boolean gregtech_isValidEnergyOutput(TileEntity tile) {
        if (!Lib.GREG) return false;
        return tile instanceof IBasicEnergyContainer && ((IBasicEnergyContainer) tile).getEUCapacity() > 0;
    }

    public static long gregtech_outputGTPower(
            Object energyContainer, byte side, long volt, long amp, boolean simulate) {
        if (!Lib.GREG) return 0;
        if (energyContainer instanceof IBasicEnergyContainer) {

            IBasicEnergyContainer container = (IBasicEnergyContainer) energyContainer;
            if (!container.inputEnergyFrom(side) || container.getStoredEU() >= container.getEUCapacity()) return 0L;
            ...
            if (((IBasicEnergyContainer) energyContainer).increaseStoredEnergyUnits(voltRound, false))
                ;
            {
                if (simulate) ((IBasicEnergyContainer) energyContainer).decreaseStoredEnergyUnits(voltRound, true);
                in++;
            }
            return in > 0 ? volt : 0;
        }
    ...
    public static String gregtech_getEnergyStored(TileEntity tile) {
        ...
        if (tile instanceof IBasicEnergyContainer) {
            ...
            if (maxStored > 0)
                return Utils.toScientificNotation(ModCompatability.convertEUtoRF(stored), "0##", 100000) + " / "
                        + Utils.toScientificNotation(ModCompatability.convertEUtoRF(maxStored), "0##", 100000);
        }
        return null;
    }
    ...
    public static enum GregsTerribleFluidPotions {
        ...
        private GregsTerribleFluidPotions(
                Potion pot, int baseDur, int baseAmp, boolean strong, boolean extended, boolean splash) {
            this.potion = pot;
