...
public class IC2Helper extends IECompatModule {
    ...
    public static double injectEnergy(
        ...
        if (!simulate) ((IEnergySink) ret).injectEnergy(fd, amount, voltage);
    ...
    public static double getCurrentItemCharge(ItemStack stack) {
        if (stack != null && stack.getItem() instanceof IElectricItem) return ElectricItem.manager.getCharge(stack);
        return 0;
    }
