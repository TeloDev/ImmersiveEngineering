...
public class HydCraftHelper extends IECompatModule {
    ...
    public void init() {
        ...
        if (pressureCore != null && pressureWall != null && hydraulicPiston != null && fLube != null)
            HCApi.getInstance()
                    .getRecipeHandler()
                    .addAssemblerRecipe(new FluidShapedOreRecipe(ieTrolly, new Object[] {
                                true,
                                new Object[] {
                                    " P ",
                                    "WCW",
                                    "SIS",
                                    'C',
                                    new ItemStack(pressureCore, 1, 1),
                                    'W',
                                    pressureWall,
                                    'S',
                                    "treatedStick",
                            ...
                            .addFluidInput(new FluidStack(fLube, 40)));
        ...
        ChemthrowerHandler.registerEffect(
                "hydraulicoil", new ChemthrowerEffect_Potion(null, 0, new PotionEffect(IEPotions.slippery.id, 80, 0)));
        ChemthrowerHandler.registerEffect(
                "fluorocarbonfluid",
                new ChemthrowerEffect_Potion(
                        null,
                        0,
                        new PotionEffect(Potion.nightVision.id, 80, 0),
                        new PotionEffect(Potion.waterBreathing.id, 80, 0)));
    }
}
