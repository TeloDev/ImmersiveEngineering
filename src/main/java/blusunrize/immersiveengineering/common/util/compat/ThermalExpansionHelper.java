...
public class ThermalExpansionHelper extends IECompatModule {
    ...
    public void init() {
        // Constantan
        addSmelterRecipe(
                new ItemStack(IEContent.itemMetal, 2, 5),
        ...
        addSmelterRecipe(
                new ItemStack(IEContent.itemMetal, 2, 5),
                new ItemStack(IEContent.itemMetal, 1, 10),
                new ItemStack(IEContent.itemMetal, 1, 14),
                1600,
                null,
                0);
        ...
        if (blockFrame != null) {
            ...
            if (fluidRedstone != null) {
                BottlingMachineRecipe.addRecipe(
                        new ItemStack(blockFrame, 1, 7),
                        new ItemStack(blockFrame, 1, 6),
                        new FluidStack(fluidRedstone, 4000));
                BottlingMachineRecipe.addRecipe(
                        new ItemStack(blockFrame, 1, 9),
                        new ItemStack(blockFrame, 1, 8),
                        new FluidStack(fluidRedstone, 4000));
            }
            Fluid fluidEnder = FluidRegistry.getFluid("ender");
            if (fluidEnder != null)
                BottlingMachineRecipe.addRecipe(
                        new ItemStack(blockFrame, 1, 11),
                        new ItemStack(blockFrame, 1, 10),
                        new FluidStack(fluidEnder, 1000));
            ...
            if (fluidGlowstone != null && blockIlluminator != null)
                BottlingMachineRecipe.addRecipe(
                        new ItemStack(blockIlluminator),
                        new ItemStack(blockFrame, 1, 12),
    ...
    public static void addSmelterRecipe(
            ...
            ItemStack input1,
            int energy,
            ItemStack secondaryOuput,
            int secondaryChance) {
        if (input0 == null || input1 == null || output == null) return;
        ...
        if (secondaryOuput != null) tag.setTag("secondaryOutput", new NBTTagCompound());
