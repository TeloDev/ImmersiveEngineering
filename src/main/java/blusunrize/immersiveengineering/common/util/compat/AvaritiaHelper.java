...
public class AvaritiaHelper extends IECompatModule {
    ...
    public void init() {
        ...
        ShaderRegistry.shaderRegistry.put(
                name,
                new ShaderRegistry.ShaderRegistryEntry(
                                name,
                                cosmicRarity,
                                new CosmicShaderCaseRevolver(
                                        overlayType,
                                        colourBackground,
                                        colourPrimary,
                                        colourSecondary,
                                        colourBlade,
                                        null),
                                new CosmicShaderCaseDrill(
                                        overlayType, colourBackground, colourPrimary, colourSecondary, null),
                                new CosmicShaderCaseChemthrower(
                                        overlayType,
                                        colourBackground,
                                        colourPrimary,
                                        colourSecondary,
                                        ...
                                        false,
                                        null),
                                new CosmicShaderCaseRailgun(
                                        overlayType, colourBackground, colourPrimary, colourSecondary, null),
                                new CosmicShaderCaseMinecart(
                                        overlayType, colourBackground, colourPrimary, colourSecondary, null))
                        .setBagLoot(true)
                        .setInLowerBags(false));
    }

    @Override
    public void postInit() {
        EnumRarity trash = EnumRarity.valueOf("TRASH");
        if (trash != null) ShaderRegistry.rarityWeightMap.put(trash, 11);

        if (Loader.isModLoaded("TConstruct")) {
            Item itemToolrod = GameRegistry.findItem("TConstruct", "toolRod");
            if (itemToolrod != null) {
                RailgunHandler.registerProjectileProperties(new ItemStack(itemToolrod, 1, 500), 20, 20)
                        .setColourMap(new int[][] {
                            {0xa4a8c0, 0x0e0e0e, 0x0e0e0e, 0x0e0e0e, 0x0e0e0e, 0x1c1c1c, 0x1c1c1c, 0xa4a8c0}
                        });
                RailgunHandler.registerProjectileProperties(new ItemStack(itemToolrod, 1, 501), 800, 2)
                        .setColourMap(new int[][] {
                            {0xe64452, 0xe64452, 0xe64452, 0xff425f, 0xff425f},
                            {0xd85085, 0xd85085, 0xd85085, 0xce41b2, 0xce41b2},
                            {0xec64f1, 0xec64f1, 0xec64f1, 0xf255f9, 0xf255f9},
                            {0xb146ff, 0xb146ff, 0xb146ff, 0x522ac8, 0x522ac8},
                            {0x7c74ee, 0x7c74ee, 0x7c74ee, 0x4a4ad5, 0x4a4ad5},
                            {0x6dc6f1, 0x6dc6f1, 0x6dc6f1, 0x57bdd9, 0x57bdd9},
                            {0x70d0a4, 0x70d0a4, 0x70d0a4, 0x74af93, 0x74af93},
                            {0x70c354, 0x70c354, 0x70c354, 0x34aa34, 0x34aa34},
                            {0x7de026, 0x7de026, 0x7de026, 0x219c21, 0x219c21},
                            {0xbcec13, 0xbcec13, 0xbcec13, 0x779202, 0x779202},
                            {0xedd02d, 0xedd02d, 0xedd02d, 0x928509, 0x928509},
    ...
    static class CosmicShaderCaseChemthrower extends ShaderCaseChemthrower {
        public CosmicShaderCaseChemthrower(
                String overlayType,
                int[] colourGrip,
                int[] colourPrimary,
                int[] colourSecondary,
        ...
        public int getPasses(ItemStack shader, ItemStack item, String modelPart) {
            if (modelPart.equals("tanks")) return (tanksUncoloured ? 1 : 2) + (additionalTexture != null ? 1 : 0);
        ...
        public void modifyRender(
            ...
            if (pass == 2) applyCosmicShader(pre, inventory);
        }
    }

    static class CosmicShaderCaseDrill extends ShaderCaseDrill {
        public CosmicShaderCaseDrill(
                String overlayType,
                int[] colourGrip,
                int[] colourPrimary,
                int[] colourSecondary,
    ...
    static class CosmicShaderCaseRailgun extends ShaderCaseRailgun {
        public CosmicShaderCaseRailgun(
                String overlayType,
                int[] colourGrip,
                int[] colourPrimary,
                int[] colourSecondary,
        ...
        @Override
        public int getPasses(ItemStack shader, ItemStack item, String modelPart) {
            if (modelPart.equals("sled") || modelPart.equals("wires")) return 1;
            int i = super.getPasses(shader, item, modelPart);
            return i + 1;
        }
        ...
        public void modifyRender(
                ItemStack shader, ItemStack item, String modelPart, int pass, boolean pre, boolean inventory) {
            if (pass == 1 && pre) GL11.glScalef(1.001f, 1.001f, 1.001f);
            if (pass == 2) applyCosmicShader(pre, inventory);
        }
    }

    static class CosmicShaderCaseMinecart extends ShaderCaseMinecart {
        public CosmicShaderCaseMinecart(
                String overlayType,
        ...
        public IIcon getReplacementIcon(ItemStack shader, ItemStack item, String modelPart, int pass) {
            if (pass == 2) return ClientEventHandler.iconItemBlank;
            return null;
        }
        ...
        public void modifyRender(
                ItemStack shader, ItemStack item, String modelPart, int pass, boolean pre, boolean inventory) {
            if (pass == 1 && pre) GL11.glScalef(1.0001f, 1.0001f, 1.0001f);
            if (pass == 2) {
    ...
    static class CosmicShaderCaseRevolver extends ShaderCaseRevolver {
        public CosmicShaderCaseRevolver(
                String overlayType,
                int[] colourGrip,
                int[] colourPrimary,
                int[] colourSecondary,
        ...
        public IIcon getReplacementIcon(ItemStack shader, ItemStack item, String modelPart, int pass) {
            ...
            if (modelPart.equals("revolver_frame")) pass--;
            if (modelPart.equals("player_bayonet")
                    || modelPart.equals("dev_bayonet")
                    || modelPart.equals("player_mag")
                    || modelPart.equals("dev_mag")) pass++;
            if (pass == 3) return ClientEventHandler.iconItemBlank;
            return icon;
        }
        ...
        public void modifyRender(
            ...
            if (pass == 3) {
                ClientUtils.bindAtlas(1);
                applyCosmicShader(pre, inventory);
                if (!pre) ClientUtils.mc().renderEngine.bindTexture(ClientProxy.revolverTextureResource);
            }
        }
    }
}
