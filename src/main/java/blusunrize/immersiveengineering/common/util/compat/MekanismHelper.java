...
public class MekanismHelper extends IECompatModule {
    ...
    public void init() {
        ...
        ChemthrowerHandler.registerEffect(
                "sulfurdioxidegas", new ChemthrowerEffect_Damage(IEDamageSources.causeAcidDamage(), 2));
        ChemthrowerHandler.registerEffect(
                "sulfurtrioxidegas", new ChemthrowerEffect_Damage(IEDamageSources.causeAcidDamage(), 2));
        ChemthrowerHandler.registerEffect(
                "sulfuricacid", new ChemthrowerEffect_Damage(IEDamageSources.causeAcidDamage(), 2));
        ChemthrowerHandler.registerEffect(
                "hydrogenchloride", new ChemthrowerEffect_Damage(IEDamageSources.causeAcidDamage(), 2));
    }
