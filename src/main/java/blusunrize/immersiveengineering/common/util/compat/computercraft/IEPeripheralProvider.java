    ...
    public IPeripheral getPeripheral(World world, int x, int y, int z, int side) {
        ...
        if (te instanceof TileEntityIEBase) {
            ...
            if (te instanceof TileEntitySampleDrill) {
                if (((TileEntitySampleDrill) te).pos == 0) return new PeripheralCoreDrill(world, x, y, z);
                else return null;
            }
            if (te instanceof TileEntityFloodlight) return new PeripheralFloodlight(world, x, y, z);
            ...
            if (te instanceof TileEntityCapacitorLV) {
                ...
                String type = "";
                if (te instanceof TileEntityCapacitorCreative) type = "creative";
                else if (te instanceof TileEntityCapacitorHV) type = "hv";
                else if (te instanceof TileEntityCapacitorMV) type = "mv";
                else if (te instanceof TileEntityCapacitorLV) type = "lv";
