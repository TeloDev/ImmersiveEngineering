 ...
 */
public class ModelRevolverVariable extends ModelBase {
    ...
    public ModelRenderer CylinderAuto;
    public ModelRenderer CylinderAuto_1;
    public ModelRenderer CylinderAuto_2;

    public ModelRevolverVariable() {
        this.textureWidth = 128;
        this.textureHeight = 64;

        this.scope1 = new ModelRenderer(this, 76, 0);
        ...
        this.Cylinder = new ModelRenderer(this, 64, 19);
        this.Cylinder.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Cylinder.addBox(-4.0F, -3.5F, -5.0F, 8, 8, 10, 0.0F);
        this.CylinderAuto = new ModelRenderer(this, 0, 0);
        this.CylinderAuto.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.CylinderAuto.addBox(-4.0F, -3.5F, -5.0F, 8, 8, 10, 0.0F);
        this.CylinderAuto_1 = new ModelRenderer(this, 36, 0);
        this.CylinderAuto_1.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.CylinderAuto_1.addBox(-13.1F, -6.0F, -5.0F, 8, 8, 10, 0.0F);
        this.CylinderAuto_2 = new ModelRenderer(this, 0, 18);
        this.CylinderAuto_2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.CylinderAuto_2.addBox(-12.0F, 1.5F, -4.0F, 9, 3, 8, 0.0F);
        this.setRotateAngle(CylinderAuto_2, 0.0F, 0.0F, 0.19198621771937624F);
        this.CylinderAuto.addChild(CylinderAuto_1);
        this.CylinderAuto.addChild(CylinderAuto_2);
        ...
        this.Body1 = new ModelRenderer(this, 16, 49);
        this.Body1.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Body1.addBox(-2.0F, -4.0F, 5.0F, 4, 7, 3, 0.0F);
        this.Body2 = new ModelRenderer(this, 16, 49);
        ...
        this.Barrel = new ModelRenderer(this, 0, 29);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.CylinderAuto.render(f5);
        this.CylinderAuto_1.render(f5);
        this.CylinderAuto_2.render(f5);
    }
