...
public class ModelPostTransformer extends ModelBase {
    ...
    public ModelPostTransformer() {
        ...
        this.Transformer.addChild(this.PoleConnection2);
        this.Transformer.addChild(this.PoleConnection1);
        this.Transformer.addChild(this.ConnectorSide);
        this.Transformer.addChild(this.ConnectorTop);
    }
