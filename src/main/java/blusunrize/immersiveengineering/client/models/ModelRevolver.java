...
public class ModelRevolver extends ModelBase {
    ...
    public ModelRevolver() {
        ...
        this.Body3.addChild(Body1);
        this.Body3.addChild(trigger);

        this.Body3.addChild(guard1);
        this.Body3.addChild(guard2);
        this.Body3.addChild(guard3);
        this.Body3.addChild(guard4);
        this.Body3.addChild(guard5);

        this.Frontgrip.addChild(Frontgrip2);

        this.Barrel.addChild(knife1);
        this.Barrel.addChild(knife2);

        this.scope2.addChild(scope1);
        this.scope2.addChild(scope3);
        this.scope2.addChild(scope4);

        this.knife5.addChild(knife3);
        this.knife5.addChild(knife4);
        this.knife5.addChild(knife6);
        this.knife6.addChild(knife7);
        this.knife6.addChild(knife8);
        this.knife6.addChild(knife9);
        this.knife6.addChild(knife10);
        this.knife6.addChild(knife11);
    }

    public void render(boolean blade) {
        this.Cylinder.render(.0625f);
        this.Body3.render(.0625f);

        this.Grip.render(.0625f);
        this.Grip2.render(.0625f);

        this.Barrel.render(.0625f);
        this.scope2.render(.0625f);
        this.Frontgrip.render(.0625f);

        if (blade) this.knife5.render(.0625f);
    }
