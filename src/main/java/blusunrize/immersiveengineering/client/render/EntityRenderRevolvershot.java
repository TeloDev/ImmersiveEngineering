...
public class EntityRenderRevolvershot extends Render {
    ...
    public void doRender(Entity entity, double x, double y, double z, float f0, float f1) {
        ...
        GL11.glRotatef(
                entity.prevRotationYaw + (entity.rotationYaw - entity.prevRotationYaw) * f1 - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(
                entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * f1, 0.0F, 0.0F, 1.0F);
