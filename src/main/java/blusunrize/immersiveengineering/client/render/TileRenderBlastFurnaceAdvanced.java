...
public class TileRenderBlastFurnaceAdvanced extends TileRenderIE {
    public static ModelIEObj model = new ModelIEObj("immersiveengineering:models/blastfurnace_advanced.obj") {
        ...
        public IIcon getBlockIcon(String groupName) {
            if (groupName.equals("furnace")) return IEContent.blockStoneDevice.getIcon(0, 5);
    ...
    public void renderStatic(TileEntity tile, Tessellator tes, Matrix4 translationMatrix, Matrix4 rotationMatrix) {
        ...
        translationMatrix.translate(
                furnace.facing == 5 ? -.5 : furnace.facing == 4 ? 1.5 : .5,
                -1,
                furnace.facing == 3 ? -.5 : furnace.facing == 2 ? 1.5 : .5);
        rotationMatrix.rotate(
                Math.toRadians(furnace.facing == 2 ? 180 : furnace.facing == 4 ? -90 : furnace.facing == 5 ? 90 : 0),
                0,
                1,
                0);
        model.render(
                tile, tes, translationMatrix, rotationMatrix, tile.getWorldObj() == null ? -1 : 0, false, "furnace");
    }
}
