        ...
        try {
            ...
            if (metadata == BlockMetalDevices.META_connectorLV) {
                ...
                ClientUtils.drawInventoryBlock(block, metadata, renderer);
                    ...
                    || metadata == BlockMetalDevices.META_conveyorDropper) {
    ...
    public boolean renderWorldBlock(
        ...
        if (metadata == BlockMetalDevices.META_connectorLV) {
            ...
            if (te1 instanceof TileEntityConveyorBelt) {
                ...
                f = tile.facing;
                y00 = tile.transportUp
                        ? (f == 5 || f == 3 ? 1 : 0)
                        : tile.transportDown ? (f == 4 || f == 2 ? 1 : 0) : 0;
                y01 = tile.transportUp
                        ? (f == 5 || f == 2 ? 1 : 0)
                        : tile.transportDown ? (f == 4 || f == 3 ? 1 : 0) : 0;
                y11 = tile.transportUp
                        ? (f == 4 || f == 2 ? 1 : 0)
                        : tile.transportDown ? (f == 5 || f == 3 ? 1 : 0) : 0;
                y10 = tile.transportUp
                        ? (f == 4 || f == 3 ? 1 : 0)
                        : tile.transportDown ? (f == 5 || f == 2 ? 1 : 0) : 0;
            }
            ...
            for (int i = 0; i < connectedBelts.length; i++) {
                ...
                if (te instanceof TileEntityConveyorBelt && ((TileEntityConveyorBelt) te).facing == i + 2)
                    ...
                    if (te instanceof TileEntityConveyorBelt
                            && ((TileEntityConveyorBelt) te).facing == i + 2
                            && ((TileEntityConveyorBelt) te).transportUp) connectedBelts[i] = true;
                    else {
                        te = world.getTileEntity(x + fd.offsetX, y + 1, z + fd.offsetZ);
                        if (te instanceof TileEntityConveyorBelt
                                && ((TileEntityConveyorBelt) te).facing == i + 2
                                && ((TileEntityConveyorBelt) te).transportDown) connectedBelts[i] = true;
                    }
                }
            }
            ...
            Vec3[] vs = {
                Vec3.createVectorHelper(
                        f == 4 || f == 5 || connectedBelts[2] ? 0 : .0625,
                        y00 + .000,
                        f == 2 || f == 3 || connectedBelts[0] ? 0 : .0625),
                Vec3.createVectorHelper(
                        f == 4 || f == 5 || connectedBelts[2] ? 0 : .0625,
                        y01 + .000,
                        f == 2 || f == 3 || connectedBelts[1] ? 1 : .9375),
                Vec3.createVectorHelper(
                        f == 4 || f == 5 || connectedBelts[3] ? 1 : .9375,
                        y10 + .000,
                        f == 2 || f == 3 || connectedBelts[0] ? 0 : .0625),
                Vec3.createVectorHelper(
                        f == 4 || f == 5 || connectedBelts[3] ? 1 : .9375,
            ...
            if (f == 2) renderer.uvRotateEast = 3;
            if (f == 3) renderer.uvRotateWest = 3;
            if (f == 4) renderer.uvRotateNorth = 3;
            if (f == 5) renderer.uvRotateSouth = 3;
