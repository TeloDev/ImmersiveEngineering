...
public class TileRenderExcavator extends TileRenderIE {
    ...
    public void renderStatic(TileEntity tile, Tessellator tes, Matrix4 translationMatrix, Matrix4 rotationMatrix) {
        ...
        translationMatrix.translate(
                excavator.facing == 4 ? 4.5 : excavator.facing == 5 ? -3.5 : .5,
                .5,
                excavator.facing == 2 ? 4.5 : excavator.facing == 3 ? -3.5 : .5);
        rotationMatrix.rotate(
                Math.toRadians(
                        excavator.facing == 4 ? 180 : excavator.facing == 3 ? -90 : excavator.facing == 2 ? 90 : 0),
                0,
                1,
                0);
