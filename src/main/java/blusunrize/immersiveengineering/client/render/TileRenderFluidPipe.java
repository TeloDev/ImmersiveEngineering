        ...
        if (tile.getWorldObj() == null) {
            ...
            switch (totalConnections) {
                ...
                case 2: // straight or curve
                    ...
                    else if (straightZ) parts.add("pipe_z");
                    else if (straightX) parts.add("pipe_x");
                    else {
                        parts.add("curve");
                ...
                case 4: // cross or complex tcross
                    ...
                    if (cross) {
                        ...
                        if (straightZ) {
                            ...
                            else if ((connections & 24) == 24) rotationMatrix.rotate(Math.PI, 0, 0, 1);
                            else if ((connections & 40) == 40) rotationMatrix.rotate(Math.PI / 2, 0, 0, 1);
                        } else {
                            rotationMatrix.rotate(Math.PI / 2, 0, 1, 0);
                            // default y- z- x+-
                            if ((connections & 8) != 0) // z+
            ...
            for (int i = 0; i < 6; i++)
                if (((TileEntityFluidPipe) tile).getConnectionStyle(i) == 1) connectionCaps.add(CONNECTIONS[i]);
