...
public class TileRenderBalloon extends TileRenderImmersiveConnectable {
    ...
    public void renderStatic(TileEntity tile, Tessellator tes, Matrix4 translationMatrix, Matrix4 rotationMatrix) {
        ...
        if (BlockRenderClothDevices.renderPass == 0 || !tile.hasWorldObj())
            ClientUtils.renderStaticWavefrontModelWithIcon(
                    balloon,
                    model,
                    IEContent.blockClothDevice.getIcon(0, 0),
                    tes,
                    translationMatrix,
                    rotationMatrix,
                    0,
        ...
        //		if(BlockRenderClothDevices.renderPass==1||!tile.hasWorldObj())
        {
            ...
            if (sCase instanceof ShaderCaseBalloon) {
                ...
                for (int pass = 0; pass < maxPasses; pass++)
                    if (tile.hasWorldObj()
                            || (pass == 0 && BlockRenderClothDevices.renderPass == 0)
                            || BlockRenderClothDevices.renderPass == 1) {
                ...
                if (balloon.style == 0) {
                    ...
                    ClientUtils.renderStaticWavefrontModelWithIcon(
                            ...
                            "balloon1_0",
                            "balloon1_1");
                    //			ClientUtils.renderStaticWavefrontModel(tile, model.model, tes, translationMatrix,
                    // rotationMatrix, -1,false, col0[0],col0[1],col0[2], "balloon0_0","balloon0_1");
                    //			ClientUtils.renderStaticWavefrontModel(tile, model.model, tes, translationMatrix,
                    // rotationMatrix, -1,false, col1[0],col1[1],col1[2], "balloon1_0","balloon1_1");
                } else {
                    ClientUtils.renderStaticWavefrontModelWithIcon(
                            balloon,
                            model,
                    ...
                    ClientUtils.renderStaticWavefrontModelWithIcon(
                            ...
                            "balloon1_1");
                    //			ClientUtils.renderStaticWavefrontModel(tile, model.model, tes, translationMatrix,
                    // rotationMatrix, -1,false, col0[0],col0[1],col0[2], "balloon0_0","balloon1_0");
                    //			ClientUtils.renderStaticWavefrontModel(tile, model.model, tes, translationMatrix,
                    // rotationMatrix, -1,false, col1[0],col1[1],col1[2], "balloon0_1","balloon1_1");
                }
            }
        }
    }
