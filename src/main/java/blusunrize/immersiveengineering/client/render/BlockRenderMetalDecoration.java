...
public class BlockRenderMetalDecoration implements ISimpleBlockRenderingHandler {
        ...
        try {
            ...
            if (metadata == BlockMetalDecoration.META_fence || metadata == BlockMetalDecoration.META_aluminiumFence) {
                ...
                ClientUtils.drawInventoryBlock(block, metadata, renderer);
                    ...
                    || metadata == BlockMetalDecoration.META_scaffolding2
                    || metadata == BlockMetalDecoration.META_aluminiumScaffolding
                    || metadata == BlockMetalDecoration.META_aluminiumScaffolding2) {
                ...
                Tessellator.instance.draw();
                    ...
                    || metadata == BlockMetalDecoration.META_aluminiumStructuralArm) {
    ...
    public boolean renderWorldBlock(
        ...
        if (meta == BlockMetalDecoration.META_fence || meta == BlockMetalDecoration.META_aluminiumFence) {
            ...
            return true;
        } else if (meta == BlockMetalDecoration.META_scaffolding
                || meta == BlockMetalDecoration.META_scaffolding2
                || meta == BlockMetalDecoration.META_aluminiumScaffolding
                || meta == BlockMetalDecoration.META_aluminiumScaffolding2) {
            renderer.setRenderBoundsFromBlock(block);
            float f = .015625f;
            float f1 = 0;
            ...
            return true;
        } else if (meta == BlockMetalDecoration.META_structuralArm
                || meta == BlockMetalDecoration.META_aluminiumStructuralArm) {
            Tessellator tes = ClientUtils.tes();
            ...
            while (rowTop < 8) {
                ...
                if (te2 instanceof TileEntityStructuralArm
                        && ((TileEntityStructuralArm) te2).facing == f
                        && ((TileEntityStructuralArm) te2).inverted == inv) rowTop++;
                else break;
            }
            int rowBot = 0;
            while (rowBot < 8) {
                ...
                if (te2 instanceof TileEntityStructuralArm
                        && ((TileEntityStructuralArm) te2).facing == f
                        && ((TileEntityStructuralArm) te2).inverted == inv) rowBot++;
                else break;
            }
            ...
            tes.setColorOpaque_F(
                    info[0].colorRedBottomRight, info[0].colorGreenBottomRight, info[0].colorBlueBottomRight);
            ...
            tes.setColorOpaque_F(
                    info[1].colorRedBottomRight, info[1].colorGreenBottomRight, info[1].colorBlueBottomRight);
            ...
            tes.addVertexWithUV(
                    x + 0, y + (inv ? 1 - y00 : y00), z + 0, iSide.getMaxU(), iSide.getInterpolatedV((1 - y00) * 16));
            ...
            tes.addVertexWithUV(
                    x + 1, y + (inv ? 1 - y10 : y10), z + 0, iSide.getMinU(), iSide.getInterpolatedV((1 - y10) * 16));
            tes.setColorOpaque_F(
                    info[2].colorRedBottomRight, info[2].colorGreenBottomRight, info[2].colorBlueBottomRight);
            ...
            tes.addVertexWithUV(
                    x + 1, y + (inv ? 1 - y10 : y10), z + 0 + .0001, iSide.getMinU(), iSide.getInterpolatedV(y10 * 16));
            ...
            tes.addVertexWithUV(
                    x + 0, y + (inv ? 1 - y00 : y00), z + 0 + .0001, iSide.getMaxU(), iSide.getInterpolatedV(y00 * 16));
            ...
            tes.setColorOpaque_F(
                    info[3].colorRedBottomRight, info[3].colorGreenBottomRight, info[3].colorBlueBottomRight);
            ...
            tes.setBrightness(info[3].brightnessTopLeft);
            tes.addVertexWithUV(
                    x + 0, y + (inv ? 1 - y01 : y01), z + 1, iSide.getMinU(), iSide.getInterpolatedV((1 - y01) * 16));
            tes.setColorOpaque_F(info[3].colorRedBottomLeft, info[3].colorGreenBottomLeft, info[3].colorBlueBottomLeft);
            tes.setBrightness(info[3].brightnessBottomLeft);
            ...
            tes.setBrightness(info[3].brightnessTopRight);
            tes.addVertexWithUV(
                    x + 1, y + (inv ? 1 - y11 : y11), z + 1, iSide.getMaxU(), iSide.getInterpolatedV((1 - y11) * 16));
            ...
            tes.setBrightness(info[2].brightnessTopLeft);
            tes.addVertexWithUV(
                    x + 0, y + (inv ? 1 - y01 : y01), z + 1 - .0001, iSide.getMinU(), iSide.getInterpolatedV(y01 * 16));
            tes.setColorOpaque_F(info[2].colorRedTopRight, info[2].colorGreenTopRight, info[2].colorBlueTopRight);
            tes.setBrightness(info[2].brightnessTopRight);
            tes.addVertexWithUV(
                    x + 1, y + (inv ? 1 - y11 : y11), z + 1 - .0001, iSide.getMaxU(), iSide.getInterpolatedV(y11 * 16));
            tes.setColorOpaque_F(
                    info[2].colorRedBottomRight, info[2].colorGreenBottomRight, info[2].colorBlueBottomRight);
            tes.setBrightness(info[2].brightnessBottomRight);
            ...
            tes.addVertexWithUV(
                    x + 0, y + (inv ? 1 - y01 : y01), z + 1, iSide.getMaxU(), iSide.getInterpolatedV((1 - y01) * 16));
            ...
            tes.addVertexWithUV(
                    x + 0, y + (inv ? 1 - y00 : y00), z + 0, iSide.getMinU(), iSide.getInterpolatedV((1 - y00) * 16));
            tes.setColorOpaque_F(
                    info[4].colorRedBottomRight, info[4].colorGreenBottomRight, info[4].colorBlueBottomRight);
            ...
            tes.addVertexWithUV(
                    x + 0 + .0001, y + (inv ? 1 - y00 : y00), z + 0, iSide.getMinU(), iSide.getInterpolatedV(y00 * 16));
            ...
            tes.addVertexWithUV(
                    x + 0 + .0001, y + (inv ? 1 - y01 : y01), z + 1, iSide.getMaxU(), iSide.getInterpolatedV(y01 * 16));
            ...
            tes.setColorOpaque_F(
                    info[5].colorRedBottomRight, info[5].colorGreenBottomRight, info[5].colorBlueBottomRight);
            ...
            tes.setBrightness(info[5].brightnessBottomRight);
            tes.addVertexWithUV(
                    x + 1, y + (inv ? 1 - y10 : y10), z + 0, iSide.getMaxU(), iSide.getInterpolatedV((1 - y10) * 16));
            tes.setColorOpaque_F(info[5].colorRedTopRight, info[5].colorGreenTopRight, info[5].colorBlueTopRight);
            tes.setBrightness(info[5].brightnessTopRight);
            tes.addVertexWithUV(
                    x + 1, y + (inv ? 1 - y11 : y11), z + 1, iSide.getMinU(), iSide.getInterpolatedV((1 - y11) * 16));
            ...
            tes.setBrightness(info[4].brightnessTopRight);
            tes.addVertexWithUV(
                    x + 1 - .0001, y + (inv ? 1 - y11 : y11), z + 1, iSide.getMinU(), iSide.getInterpolatedV(y11 * 16));
            tes.setColorOpaque_F(
                    info[4].colorRedBottomRight, info[4].colorGreenBottomRight, info[4].colorBlueBottomRight);
            tes.setBrightness(info[4].brightnessBottomRight);
            tes.addVertexWithUV(
                    x + 1 - .0001, y + (inv ? 1 - y10 : y10), z + 0, iSide.getMaxU(), iSide.getInterpolatedV(y10 * 16));
