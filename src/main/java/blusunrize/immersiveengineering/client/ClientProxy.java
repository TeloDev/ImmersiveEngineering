...
public class ClientProxy extends CommonProxy {
    ...
    public static final ResourceLocation revolverTextureResource =
            new ResourceLocation("textures/atlas/immersiveengineering/revolvers.png");
    ...
    public void init() {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
                TileEntityConnectorStructural.class, new TileRenderConnectorStructural());
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
                TileEntityBlastFurnacePreheater.class, new TileRenderBlastFurnacePreheater());
        // MULTIBLOCKS
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
                TileEntityWindmillAdvanced.class, new TileRenderWindmillAdvanced());
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
                TileEntityBlastFurnaceAdvanced.class, new TileRenderBlastFurnaceAdvanced());
        // CLOTH
        ...
        RenderingRegistry.registerEntityRenderingHandler(
                EntityChemthrowerShot.class, new EntityRenderChemthrowerShot());
        // VOLTMETER
        ...
        VillagerRegistry.instance()
                .registerVillagerSkin(
                        villagerId, new ResourceLocation("immersiveengineering:textures/models/villager_engineer.png"));
    ...
    public void postInit() {
        ...
        int maxSubVersion = 0;
        while (!(ManualHelper.ieManualInstance
                .formatEntryName("updateNews_" + maxSubVersion)
                .equals("ie.manual.entry.updateNews_" + maxSubVersion + ".name"))) maxSubVersion++;
        for (int subVersion = (maxSubVersion - 1); subVersion >= 0; subVersion--) {
            ArrayList<IManualPage> pages = new ArrayList<IManualPage>();
            int i = 0;
            String key;
            while (!ManualHelper.ieManualInstance
                            .formatText(key = "updateNews_" + subVersion + "" + i)
                            .equals(key)
                    && i < 5) {
            ...
            ManualHelper.addEntry(
                    "updateNews_" + subVersion, ManualHelper.CAT_UPDATE, pages.toArray(new IManualPage[pages.size()]));
        }

        ManualHelper.addEntry(
                "introduction",
                ManualHelper.CAT_GENERAL,
                ...
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "introductionHammer", new ItemStack(IEContent.itemTool, 1, 0)));
        ManualHelper.addEntry(
                "ores",
                ManualHelper.CAT_GENERAL,
                new ManualPages.ItemDisplay(
                        ...
                        "oresCopper",
                        new ItemStack(IEContent.blockOres, 1, 0),
                        new ItemStack(IEContent.itemMetal, 1, 0)),
                new ManualPages.ItemDisplay(
                        ManualHelper.getManual(),
                        "oresBauxite",
                        new ItemStack(IEContent.blockOres, 1, 1),
                        new ItemStack(IEContent.itemMetal, 1, 1)),
                new ManualPages.ItemDisplay(
                        ManualHelper.getManual(),
                        "oresLead",
                        new ItemStack(IEContent.blockOres, 1, 2),
                        new ItemStack(IEContent.itemMetal, 1, 2)),
                new ManualPages.ItemDisplay(
                        ManualHelper.getManual(),
                        "oresSilver",
                        new ItemStack(IEContent.blockOres, 1, 3),
                        new ItemStack(IEContent.itemMetal, 1, 3)),
                new ManualPages.ItemDisplay(
                        ManualHelper.getManual(),
                        "oresNickel",
                        new ItemStack(IEContent.blockOres, 1, 4),
                        new ItemStack(IEContent.itemMetal, 1, 4)));
        ...
        if (!IERecipes.hammerCrushingList.isEmpty()) {
            for (String ore : IERecipes.hammerCrushingList)
                recipes.add(new PositionedItemStack[] {
                    new PositionedItemStack(OreDictionary.getOres("ore" + ore), 24, 0),
                    new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                    new PositionedItemStack(IEApi.getPreferredOreStack("dust" + ore), 78, 0)
                });
            if (!recipes.isEmpty())
                ManualHelper.addEntry(
                        "oreProcessing",
                        ManualHelper.CAT_GENERAL,
                        new ManualPages.CraftingMulti(ManualHelper.getManual(), "oreProcessing0", (Object[])
                                recipes.toArray(new PositionedItemStack[recipes.size()][3])));
        }
        ManualHelper.addEntry(
                "alloys",
                ManualHelper.CAT_GENERAL,
                new ManualPages.CraftingMulti(
                        ManualHelper.getManual(), "alloys0", (Object[]) new PositionedItemStack[][] {
                            new PositionedItemStack[] {
                                new PositionedItemStack(OreDictionary.getOres("dustCopper"), 24, 0),
                                new PositionedItemStack(OreDictionary.getOres("dustNickel"), 42, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemMetal, 2, 15), 78, 0)
                            },
                            new PositionedItemStack[] {
                                new PositionedItemStack(OreDictionary.getOres("dustGold"), 24, 0),
                                new PositionedItemStack(OreDictionary.getOres("dustSilver"), 42, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemMetal, 2, 16), 78, 0)
                            }
                        }));
        ManualHelper.addEntry(
                "plates",
                ManualHelper.CAT_GENERAL,
                new ManualPages.CraftingMulti(
                        ManualHelper.getManual(), "plates0", (Object[]) new PositionedItemStack[][] {
                            new PositionedItemStack[] {
                                new PositionedItemStack(OreDictionary.getOres("ingotIron"), 24, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemMetal, 1, 30), 78, 0)
                            },
                            new PositionedItemStack[] {
                                new PositionedItemStack(OreDictionary.getOres("ingotAluminum"), 24, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemMetal, 1, 32), 78, 0)
                            },
                            new PositionedItemStack[] {
                                new PositionedItemStack(OreDictionary.getOres("ingotLead"), 24, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemMetal, 1, 33), 78, 0)
                            },
                            new PositionedItemStack[] {
                                new PositionedItemStack(OreDictionary.getOres("ingotConstantan"), 24, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemMetal, 1, 36), 78, 0)
                            },
                            new PositionedItemStack[] {
                                new PositionedItemStack(OreDictionary.getOres("ingotSteel"), 24, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                                new PositionedItemStack(new ItemStack(IEContent.itemMetal, 1, 38), 78, 0)
                            }
                        }));
        ManualHelper.addEntry(
                "hemp",
                ...
                new ManualPages.ItemDisplay(
                        ManualHelper.getManual(),
                        "hemp0",
                        new ItemStack(IEContent.blockCrop, 1, 5),
                        new ItemStack(IEContent.itemSeeds)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "hemp1", new ItemStack(IEContent.itemMaterial, 1, 4)));
        ManualHelper.addEntry(
                "cokeoven",
                ManualHelper.CAT_GENERAL,
                new ManualPages.Text(ManualHelper.getManual(), "cokeoven0"),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "cokeovenBlock", new ItemStack(IEContent.blockStoneDecoration, 1, 1)),
        ...
        ManualHelper.addEntry(
                "graphite",
                ManualHelper.CAT_GENERAL,
                new ManualPages.Text(ManualHelper.getManual(), "graphite0"),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "graphite1", new ItemStack(IEContent.itemBlueprint, 1, blueprint)));
        ManualHelper.addEntry(
                "shader",
                ManualHelper.CAT_GENERAL,
                new ManualPages.Text(ManualHelper.getManual(), "shader0"),
                new ManualPages.ItemDisplay(ManualHelper.getManual(), "shader1"),
                new ManualPages.CraftingMulti(ManualHelper.getManual(), "shader2"));
        ...
        ManualHelper.addEntry(
                ...
                new ManualPages.Crafting(
                        ...
                        new ItemStack(IEContent.blockWoodenStair)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "",
                        new ItemStack(IEContent.itemMaterial, 1, 0),
                        new ItemStack(IEContent.blockWoodenDecoration, 1, 1),
                        new ItemStack(IEContent.blockWoodenDecoration, 1, 6)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "treatedwoodPost0", new ItemStack(IEContent.blockWoodenDevice, 1, 0)),
        ...
        ManualHelper.addEntry(
                ...
                ManualHelper.CAT_CONSTRUCTION,
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "crate0", new ItemStack(IEContent.blockWoodenDevice, 1, 4)));
        ManualHelper.addEntry(
                "barrel",
                ManualHelper.CAT_CONSTRUCTION,
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "barrel0", new ItemStack(IEContent.blockWoodenDevice, 1, 6)));
        ManualHelper.addEntry(
                "metalconstruction",
                ManualHelper.CAT_CONSTRUCTION,
                ...
                new ManualPages.Crafting(
                        ...
                        new ItemStack(IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_structuralArm)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "",
                        new ItemStack(IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_wallMount)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "metalconstruction2",
                        new ItemStack(
                                IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_connectorStructural)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "",
                        new ItemStack(IEContent.itemWireCoil, 1, 3),
                        new ItemStack(IEContent.itemWireCoil, 1, 4)));
        ManualHelper.addEntry(
                "concrete",
                ManualHelper.CAT_CONSTRUCTION,
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "concrete0", new ItemStack(IEContent.blockStoneDecoration, 1, 4)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "",
                        new ItemStack(IEContent.blockStoneDecoration, 1, 5),
                        new ItemStack(IEContent.blockConcreteStair, 1, 0),
                        new ItemStack(IEContent.blockConcreteTileStair, 1, 0)));
        ManualHelper.addEntry(
                "multiblocks",
                ManualHelper.CAT_CONSTRUCTION,
                ...
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "",
                        new ItemStack(IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_generator),
                        new ItemStack(IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_radiator)));
        ManualHelper.addEntry(
                "metalbarrel",
                ManualHelper.CAT_CONSTRUCTION,
                new ManualPages.Crafting(
        ...
        ManualHelper.addEntry(
                ...
                ManualHelper.CAT_CONSTRUCTION,
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "workbench0", new ItemStack(IEContent.blockWoodenDevice, 1, 5)));
        ManualHelper.addEntry(
                "blueprints",
                ManualHelper.CAT_CONSTRUCTION,
                new ManualPages.Text(ManualHelper.getManual(), "blueprints0"),
                new ManualPages.Text(ManualHelper.getManual(), "blueprints1"));
        ManualHelper.addEntry(
                "lighting",
                ManualHelper.CAT_CONSTRUCTION,
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "lighting0",
                        new ItemStack(IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_lantern)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "lighting1",
                        new ItemStack(IEContent.blockMetalDevice2, 1, BlockMetalDevices2.META_electricLantern)),
        ...
        ManualHelper.addEntry(
                ...
                ManualHelper.CAT_CONSTRUCTION,
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "balloon0", new ItemStack(IEContent.blockClothDevice, 1, 0)),
        ...
        ManualHelper.addEntry(
                ...
                new ManualPages.Image(
                        ManualHelper.getManual(),
                        "wiring2",
                        "immersiveengineering:textures/misc/wiring.png;0;0;110;40",
                        "immersiveengineering:textures/misc/wiring.png;0;40;110;30"),
                new ManualPages.Image(
                        ManualHelper.getManual(),
                        "wiring3",
                        "immersiveengineering:textures/misc/wiring.png;0;70;110;60",
                        "immersiveengineering:textures/misc/wiring.png;0;130;110;60"),
                ...
                new ManualPages.CraftingMulti(
                        ...
                        new ItemStack(IEContent.blockMetalDevice, 1, BlockMetalDevices.META_relayHV),
                ...
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "wiringCutters", new ItemStack(IEContent.itemTool, 1, 1)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "wiringVoltmeter", new ItemStack(IEContent.itemTool, 1, 2)));
        ManualHelper.getManual()
                .addEntry(
                        "generator",
                        ManualHelper.CAT_ENERGY,
        ...
        ManualHelper.getManual()
                .addEntry(
                        ...
                        new ManualPages.Text(ManualHelper.getManual(), "breaker1"),
                        new ManualPages.Crafting(
                                ManualHelper.getManual(),
                                "breaker2",
                                new ItemStack(
                                        IEContent.blockMetalDevice2, 1, BlockMetalDevices2.META_redstoneBreaker)));
        ManualHelper.getManual()
                .addEntry(
                        "eMeter",
                        ManualHelper.CAT_ENERGY,
        ...
        ManualHelper.addEntry(
                ...
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "",
                        new ItemStack(IEContent.blockMetalDevice, 1, 8),
                        new ItemStack(IEContent.blockMetalDevice, 1, 4)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "",
                        new ItemStack(IEContent.blockMetalDevice, 1, 5),
                        new ItemStack(IEContent.blockMetalDevice, 1, 7)));
        ...
        ManualHelper.addEntry(
                ...
                new ManualPages.Text(ManualHelper.getManual(), "chargingStation1"));
        ManualHelper.addEntry(
                "jerrycan",
                ManualHelper.CAT_MACHINES,
                new ManualPages.Crafting(ManualHelper.getManual(), "jerrycan0", new ItemStack(IEContent.itemJerrycan)));
        ManualHelper.addEntry(
                "toolbox",
                ManualHelper.CAT_MACHINES,
                new ManualPages.Crafting(ManualHelper.getManual(), "toolbox0", new ItemStack(IEContent.itemToolbox)));
        ManualHelper.addEntry(
                "drill",
                ManualHelper.CAT_MACHINES,
                new ManualPages.CraftingMulti(
                ...
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "drill1", new ItemStack(IEContent.itemDrillhead, 1, 0)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "drill2", new ItemStack(IEContent.itemToolUpgrades, 1, 0)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "drill3", new ItemStack(IEContent.itemToolUpgrades, 1, 1)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "drill4", new ItemStack(IEContent.itemToolUpgrades, 1, 2)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "drill5", new ItemStack(IEContent.itemToolUpgrades, 1, 3)));
        ...
        ManualHelper.addEntry(
                ...
                new ManualPages.CraftingMulti(
                        ManualHelper.getManual(), "revolver1", new ItemStack(IEContent.itemRevolver, 1, 1)),
                //				new ManualPages.CraftingMulti(ManualHelper.getManual(), "revolver2", new
                // ItemStack(IEContent.itemBlueprint,1,blueprint_bullet)),
                //				new ManualPages.Text(ManualHelper.getManual(), "revolver3"),
                //				new ManualPages.Text(ManualHelper.getManual(), "revolver4"),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "revolver2", new ItemStack(IEContent.itemToolUpgrades, 1, 4)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "revolver3", new ItemStack(IEContent.itemToolUpgrades, 1, 5)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "revolver4", new ItemStack(IEContent.itemToolUpgrades, 1, 6)));
        ArrayList<IManualPage> pages = new ArrayList<IManualPage>();
        pages.add(new ManualPages.CraftingMulti(
                ManualHelper.getManual(),
                "bullets0",
                new ItemStack(IEContent.itemBlueprint, 1, blueprint_bullet),
                new ItemStack(IEContent.itemBullet, 1, 0),
                new ItemStack(IEContent.itemBullet, 1, 1)));
        pages.add(new ManualPages.ItemDisplay(
                ManualHelper.getManual(), "bullets1", new ItemStack(IEContent.itemBullet, 1, 2)));
        pages.add(new ManualPages.ItemDisplay(
                ManualHelper.getManual(), "bullets2", new ItemStack(IEContent.itemBullet, 1, 3)));
        pages.add(new ManualPages.ItemDisplay(
                ManualHelper.getManual(), "bullets3", new ItemStack(IEContent.itemBullet, 1, 4)));
        pages.add(new ManualPages.ItemDisplay(
                ManualHelper.getManual(), "bullets4", new ItemStack(IEContent.itemBullet, 1, 5)));
        pages.add(new ManualPages.ItemDisplay(
                ManualHelper.getManual(), "bullets5", new ItemStack(IEContent.itemBullet, 1, 9)));
        pages.add(new ManualPages.ItemDisplay(
                ManualHelper.getManual(), "bullets6", new ItemStack(IEContent.itemBullet, 1, 6)));
        pages.add(new ManualPages.ItemDisplay(
                ManualHelper.getManual(), "bullets7", new ItemStack(IEContent.itemBullet, 1, 10)));
        if (Config.getBoolean("botaniaBullets")) {
            pages.add(new ManualPages.ItemDisplay(
                    ManualHelper.getManual(), "bulletsBotania0", new ItemStack(IEContent.itemBullet, 1, 7)));
            pages.add(new ManualPages.ItemDisplay(
                    ManualHelper.getManual(), "bulletsBotania1", new ItemStack(IEContent.itemBullet, 1, 8)));
        }
        ...
        ManualHelper.addEntry(
                ...
                new ManualPages.CraftingMulti(
                        ManualHelper.getManual(),
                        "skyhook0",
                        new ItemStack(IEContent.itemSkyhook),
                        new ItemStack(IEContent.itemMaterial, 1, 9)),
        ...
        ManualHelper.addEntry(
                ...
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "chemthrower1", new ItemStack(IEContent.itemToolUpgrades, 1, 3)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "chemthrower2", new ItemStack(IEContent.itemToolUpgrades, 1, 7)));
        ManualHelper.addEntry(
                "railgun",
                ManualHelper.CAT_MACHINES,
                new ManualPages.CraftingMulti(
                ...
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "railgun2", new ItemStack(IEContent.itemToolUpgrades, 1, 9)),
                new ManualPages.Crafting(
                        ManualHelper.getManual(), "railgun3", new ItemStack(IEContent.itemToolUpgrades, 1, 8)));

        ManualHelper.addEntry(
                "improvedBlastfurnace",
                ManualHelper.CAT_HEAVYMACHINES,
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "improvedBlastfurnace0",
                        new ItemStack(IEContent.blockStoneDecoration, 1, 6)),
                new ManualPageMultiblock(
                        ManualHelper.getManual(), "improvedBlastfurnace1", MultiblockBlastFurnaceAdvanced.instance),
                new ManualPages.Text(ManualHelper.getManual(), "improvedBlastfurnace2"),
                new ManualPages.Crafting(
                        ManualHelper.getManual(),
                        "improvedBlastfurnace3",
        ...
        ManualHelper.addEntry(
                ...
                new ManualPages.CraftingMulti(ManualHelper.getManual(), "metalPress2", (Object[])
        ...
        ManualHelper.addEntry(
                ...
                ManualHelper.CAT_HEAVYMACHINES,
                new ManualPageMultiblock(
                        ManualHelper.getManual(), "bottlingMachine0", MultiblockBottlingMachine.instance),
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == Lib.GUIID_Manual
                && ManualHelper.getManual() != null
                && player.getCurrentEquippedItem() != null
                && OreDictionary.itemMatches(
                        new ItemStack(IEContent.itemTool, 1, 3), player.getCurrentEquippedItem(), false))
    ...
    public void handleTileSound(String soundName, TileEntity tile, boolean tileActive, float volume, float pitch) {
        ...
        if (sound != null) {
            if (sound.getXPosF() == tile.xCoord && sound.getYPosF() == tile.yCoord && sound.getZPosF() == tile.zCoord) {
                ...
                double dx = (sound.getXPosF() - ClientUtils.mc().renderViewEntity.posX)
                        * (sound.getXPosF() - ClientUtils.mc().renderViewEntity.posX);
                double dy = (sound.getYPosF() - ClientUtils.mc().renderViewEntity.posY)
                        * (sound.getYPosF() - ClientUtils.mc().renderViewEntity.posY);
                double dz = (sound.getZPosF() - ClientUtils.mc().renderViewEntity.posZ)
                        * (sound.getZPosF() - ClientUtils.mc().renderViewEntity.posZ);
                double dx1 = (tile.xCoord - ClientUtils.mc().renderViewEntity.posX)
                        * (tile.xCoord - ClientUtils.mc().renderViewEntity.posX);
                double dy1 = (tile.yCoord - ClientUtils.mc().renderViewEntity.posY)
                        * (tile.yCoord - ClientUtils.mc().renderViewEntity.posY);
                double dz1 = (tile.zCoord - ClientUtils.mc().renderViewEntity.posZ)
                        * (tile.zCoord - ClientUtils.mc().renderViewEntity.posZ);
            ...
            sound = ClientUtils.generatePositionedIESound(
                    "immersiveengineering:" + soundName, volume, pitch, true, 0, tile.xCoord, tile.yCoord, tile.zCoord);
            soundMap.put(soundName, sound);
        }
    }
    ...
    public void stopTileSound(String soundName, TileEntity tile) {
        IESound sound = soundMap.get(soundName);
        if (sound != null
                && sound.getXPosF() == tile.xCoord
                && sound.getYPosF() == tile.yCoord
                && sound.getZPosF() == tile.zCoord) {
            ClientUtils.mc().getSoundHandler().stopSound(sound);
            sound = null;
        }
    }
        ...
        if (stack != null)
            for (int i = 0; i < 3; i++) {
                double x = tile.xCoord
                        + .5
                        + .5 * (tile.facing < 4 ? tile.getWorldObj().rand.nextGaussian() - .5 : 0);
                double y = tile.yCoord + 2 + tile.getWorldObj().rand.nextGaussian() / 2;
                double z = tile.zCoord
                        + .5
                        + .5 * (tile.facing > 3 ? tile.getWorldObj().rand.nextGaussian() - .5 : 0);
                ...
                if (stack.getItem().getSpriteNumber() == 0)
                    particle = new EntityFXBlockParts(
                            tile.getWorldObj(), stack, tile.getWorldObj().rand.nextInt(16), x, y, z, mX, mY, mZ);
                else
                    particle = new EntityFXItemParts(
                            tile.getWorldObj(), stack, tile.getWorldObj().rand.nextInt(16), x, y, z, mX, mY, mZ);
    ...
    public void spawnBucketWheelFX(TileEntityBucketWheel tile, ItemStack stack) {
        if (stack != null && Config.getBoolean("excavator_particles"))
            for (int i = 0; i < 16; i++) {
                double x = tile.xCoord
                        + .5
                        + .1 * (tile.facing < 4 ? 2 * (tile.getWorldObj().rand.nextGaussian() - .5) : 0);
                double y = tile.yCoord + 2.5; // + tile.getWorldObj().rand.nextGaussian()/2;
                double z = tile.zCoord
                        + .5
                        + .1 * (tile.facing > 3 ? 2 * (tile.getWorldObj().rand.nextGaussian() - .5) : 0);
                double mX = ((tile.facing == 4 ? -.075 : tile.facing == 5 ? .075 : 0) * (tile.mirrored ? -1 : 1))
                        + ((tile.getWorldObj().rand.nextDouble() - .5) * .01);
                double mY = -.15D; // tile.getWorldObj().rand.nextGaussian() * -0.05D;
                double mZ = ((tile.facing == 2 ? -.075 : tile.facing == 3 ? .075 : 0) * (tile.mirrored ? -1 : 1))
                        + ((tile.getWorldObj().rand.nextDouble() - .5) * .01);
    ...
    public void draw3DBlockCauldron() {
        ...
        blockRender.renderFaceYPos(
                Blocks.cauldron, (double) 0, (double) ((float) 0 - 1.0F + 0.25F), (double) 0, iicon1);
        blockRender.renderFaceYNeg(
                Blocks.cauldron, (double) 0, (double) ((float) 0 + 1.0F - 0.75F), (double) 0, iicon1);
        Tessellator.instance.addTranslation(.5f, .5f, .5f);
        ...
        try {
            for (int i = 0; i < sortedMapArray.length; i++) {
                ...
                if (ApiUtils.isExistingOreName(sortedMapArray[i].getKey())) {
                    ItemStack is =
                            OreDictionary.getOres(sortedMapArray[i].getKey()).get(0);
                    if (is != null) item = is.getDisplayName();
                    ...
                    if (it != null) item = new ItemStack(it, 1, meta).getDisplayName();
                } else item = sortedMapArray[i].getKey();
