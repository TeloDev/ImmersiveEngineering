...
public class NEIRefineryHandler extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId == getOverlayIdentifier())
            for (RefineryRecipe r : DieselHandler.refineryList)
                if (r != null) this.arecipes.add(new CachedRefineryRecipe(r));
        ...
        if (fs != null)
            for (RefineryRecipe r : DieselHandler.refineryList)
                if (r != null && r.output.isFluidEqual(fs)) this.arecipes.add(new CachedRefineryRecipe(r));
    }
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        ...
        if (inputId == "liquid"
                ...
                && ingredients[0] instanceof FluidStack) fs = (FluidStack) ingredients[0];
        if (inputId == "item"
                && ingredients != null
                && ingredients.length > 0
                && ingredients[0] instanceof ItemStack
                && FluidContainerRegistry.isFilledContainer((ItemStack) ingredients[0]))
    ...
    public boolean keyTyped(GuiRecipe gui, char keyChar, int keyCode, int recipe) {
        ...
        if (r != null) {
            ...
            FluidStack fs = null;
            if (localPoint.x > gl + 12
                    && localPoint.x <= gl + 12 + 16
                    && localPoint.y > gt + (64 * (recipe % 2)) + 11
                    && localPoint.y <= gt + (64 * (recipe % 2)) + 11 + 47) fs = r.fluid0;
            else if (localPoint.x > gl + 60
                    && localPoint.x <= gl + 60 + 16
                    && localPoint.y > gt + (64 * (recipe % 2)) + 11
                    && localPoint.y <= gt + (64 * (recipe % 2)) + 11 + 47) fs = r.fluid1;
            else if (localPoint.x > gl + 108
                    && localPoint.x <= gl + 108 + 16
                    && localPoint.y > gt + (64 * (recipe % 2)) + 11
                    && localPoint.y <= gt + (64 * (recipe % 2)) + 1 + 47) fs = r.fluidOut;
    ...
    public List<String> handleTooltip(GuiRecipe gui, List<String> list, int recipe) {
        ...
        if (r != null) {
            ...
            if (r.fluid0 != null
                    ...
                    && localPoint.x <= gl + 12 + 16
                    && localPoint.y > gt + (64 * (recipe % 2)) + 11
                    && localPoint.y <= gt + (64 * (recipe % 2)) + 11 + 47) {
