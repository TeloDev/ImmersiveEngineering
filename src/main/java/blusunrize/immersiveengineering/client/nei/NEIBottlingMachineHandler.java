...
public class NEIBottlingMachineHandler extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId == getOverlayIdentifier())
            for (BottlingMachineRecipe r : BottlingMachineRecipe.recipeList)
                if (r != null) this.arecipes.add(new CachedBottlingMachineRecipe(r));
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        ...
        if (fs != null)
            for (BottlingMachineRecipe r : BottlingMachineRecipe.recipeList)
                if (r != null && r.fluidInput.isFluidEqual(fs)) this.arecipes.add(new CachedBottlingMachineRecipe(r));
