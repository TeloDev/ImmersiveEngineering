...
public class NEISqueezerHandler extends TemplateRecipeHandler {
    public class CachedSqueezerRecipe extends CachedRecipe {
        ...
        public CachedSqueezerRecipe(SqueezerRecipe recipe) {
            ...
            if (recipe.output != null) output = new PositionedStack(recipe.output, 86, 27);
            fluid = recipe.fluid;
            time = recipe.time;
        }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        ...
        for (SqueezerRecipe r : DieselHandler.squeezerList)
            if (r != null)
                if (outputId == getOverlayIdentifier()) this.arecipes.add(new CachedSqueezerRecipe(r));
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        if (ingredient != null) {
            ...
            if (r != null) this.arecipes.add(new CachedSqueezerRecipe(r));
        }
    }
