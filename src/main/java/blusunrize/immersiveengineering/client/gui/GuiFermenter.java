...
public class GuiFermenter extends GuiContainer {
    ...
    public void drawScreen(int mx, int my, float partial) {
        ...
        ClientUtils.handleGuiTank(
                ...
                mx,
                my,
                "immersiveengineering:textures/gui/fluidProducer.png",
                tooltip);
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int mx, int my) {
        ...
        if (tile.tick > 0) {
            ...
            ClientUtils.drawGradientRect(
                    guiLeft + 80, guiTop + 34 + h, guiLeft + 87, guiTop + 52, 0xffd4d2ab, 0xffc4c29e);
        }

        int stored =
                (int) (46 * (tile.energyStorage.getEnergyStored() / (float) tile.energyStorage.getMaxEnergyStored()));
        ClientUtils.drawGradientRect(
                guiLeft + 157, guiTop + 22 + (46 - stored), guiLeft + 164, guiTop + 68, 0xffb51500, 0xff600b00);
